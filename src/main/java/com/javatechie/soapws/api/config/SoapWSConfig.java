package com.javatechie.soapws.api.config;
...
public class SoapWSConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema myXSDSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://www.javatechie.com/soapws/api");
    ...
    public XsdSchema myXSDSchema() {
        return new SimpleXsdSchema(new ClassPathResource("loanCriteria.xsd"));
    }
}
